...
by providing the algorithm with a numerical way to compute the system's ODE though CasADi callbacks 
containing OpenSim functions"""
...
class MyOsimCallback(ca.Callback):
  ...
  def get_jacobian(self, name, osim_model, state, nCoords, opts={}):
    class JacFun(MyOsimCallback):
      def __init__(self, opts={}):
        MyOsimCallback.__init__(self, name, osim_model, state, nCoords)
        self.construct(name, opts)
